...
##    url='http://www.11v11.com/matches/arsenal-v-bayern-mA14nchen-09-march-2005-27849/'
    ...
    try:
        ...
        if '(' in homegoals:
            homegoals=re.sub('\(.*?\)','',homegoals)
            homegoals=homegoals.strip()
            print homegoals
    ...
    try:
        ...
        if '(' in awaygoals:
            awaygoals=re.sub('\(.*?\)','',awaygoals)
            awaygoals=awaygoals.strip()
            print awaygoals
